...
Existem várias arquiteturas propostas para objetos distribuídos, tais como:
\begin{enumerate}
...
nenhuma deles é totalmente satisfatória.
Para nossos propósitos é suficiente dar uma caracterização frouxa, tal como: um
sistema distribuído é uma coleção de computadores para os seus utilizadores como um único sistema coerente \cite{distribuidos:2006}.
...
Como estabelecer esta colaboração que está no centro dos
